...
//"Towards Adaptive Knowledge Transfer in Multifactorial Evolutionary Computation" based on the framework of MOMFEA

public class MFEAAKT extends Algorithm {
	...
	public MFEAAKT(ProblemSet problemSet) {
		super(problemSet);
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		crossover = (AdaOperator) operators_.get("crossover");
		crossover1 = (AdaOperator) operators_.get("crossover1");
