...
public class MOEAD extends MaTAlgorithm {
	 ...
	 *            Problem to solve
	 */
	public MOEAD(ProblemSet problemSet) throws JMException, ClassNotFoundException {
		super(problemSet);
...
//		// STEP 1.3. Initialize z_
	...
	public boolean step() throws JMException, ClassNotFoundException {
		int evaluations = 0;
		int maxEvaluations = populationSize_;
		while (evaluations_ < maxEvaluations_ && evaluations < maxEvaluations){
			int[] permutation = new int[populationSize_];
			Utils.randomPermutation(permutation, populationSize_);
