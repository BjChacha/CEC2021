...
public class MaTBML_I extends MtoAlgorithm {
    ...
    public MaTBML_I(ProblemSet problemSet){
        super(problemSet);
    }
...
//            }
            ...
            SolutionSet offspringSet = new SolutionSet(checkSize);
...
//            System.out.println((double)evaluations_ * 100 / maxEvaluations_ + "%: 隐式迁移存活率：" + ((double) transferCount / offspringSet.size()));
        }
        updateIdealPoint();
        updateNadirPoint();
    }
