...
public class MaTBMLx_DIS_main {
    ...
    public static void main(String[] args) throws JMException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        System.out.println("Algo: MaTBMLx.");
        ...
        for (DISTANCE_TPYE = 0; DISTANCE_TPYE < 3; DISTANCE_TPYE++) {
...
//            crossover = CrossoverFactory.getCrossoverOperator("RandomDECrossover",parameters);
                ...
                if (DISTANCE_TPYE == 0){
                    signDistance = "RND";
                }else if(DISTANCE_TPYE == 1){
                    signDistance = "WD";
                }else{
                    signDistance = "KL";
                }
                if (LOG_IGD) {
                    LogIGD.LogIGD("MaTBMLx(" + signDistance + ")_" + benchmark_name, pCase, igds);
                }
            }
        }
    }
