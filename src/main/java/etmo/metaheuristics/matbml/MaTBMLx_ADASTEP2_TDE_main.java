...
public class MaTBMLx_ADASTEP2_TDE_main {
    // 0: random; 1: WD; 2: KL;
    ...
    public static void main(String[] args) throws JMException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        for (int pCase = problemStart; pCase <= problemEnd; pCase++) {
                ...
                algorithm = new MaTBMLx_ADASTEP2_TDE(problemSet);
...
//                crossover = CrossoverFactory.getCrossoverOperator("SBXCrossover", parameters);
                ...
                if (LOG_IGD) {
                    LogIGD.LogIGD("MaTBMLx(MaOEAC_IEMIX_PUNISH_TDE_NoLEADER_WD_NewRA1)" + "_" + benchmark_name, pCase, igds);
                }
            }
    }
}
