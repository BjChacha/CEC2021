...
public abstract class MtoAlgorithmWithPlot implements Serializable {
    ...
    protected Map<String, XYChart> charts;
     ...
     */
    public MtoAlgorithmWithPlot(ProblemSet problemSet) {
