...
public class ETMOF2 {
	...
	public static ProblemSet getT1() throws IOException {
		...
		double[][] matrix = IO.readMatrixFromFile("resources/MData/CEC2021/benchmark_2/matrix_1");
		prob.setRotationMatrix(matrix);	
		((Problem)prob).setName("ETOMF2_1");
	...
	public static ProblemSet getT2() throws IOException {
		...
		double[][] matrix = IO.readMatrixFromFile("resources/MData/CEC2021/benchmark_2/matrix_2");
		prob.setRotationMatrix(matrix);	
		((Problem)prob).setName("ETOMF2_2");
