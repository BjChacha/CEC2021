...
public class ETMOF10 {
	...
	public static ProblemSet getT1() throws IOException {
		...
		double[][] matrix = IO.readMatrixFromFile("resources/MData/CEC2021/benchmark_10/matrix_1");
	...
	public static ProblemSet getT2() throws IOException {
		...
		double[][] matrix = IO.readMatrixFromFile("resources/MData/CEC2021/benchmark_10/matrix_2");
		prob.setRotationMatrix(matrix);	
